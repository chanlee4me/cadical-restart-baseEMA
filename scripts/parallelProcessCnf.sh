...
count=0
ls *.cnf | xargs -n 2 -P 192 -I {} bash -c '
 if [ $0 -ge $1 ]; then
 ...
 timeout 3600  /home/wgf/chenli/SAT/restart_strategy/restartCadical/real_raw_cadical/build/cadical $str |awk -F "[{}]"  "/statistics/{flag1=1;next} flag1{print \$0; if(++n1==29) flag1=0} /resources/{flag2=1;next} flag2{print \$0; if(++n2==6) exit}"   >>$temp_file
 printf "\n" >>$temp_file
 echo "end $str"

 mv $temp_file /home/wgf/chenli/SAT/real_ori_result.csv.$BASHPID
...
cat /home/wgf/chenli/SAT/real_ori_result.csv.* >> /home/wgf/chenli/SAT/real_ori_result.csv

# Remove temporary files
rm /home/wgf/chenli/SAT/real_ori_result.csv.*